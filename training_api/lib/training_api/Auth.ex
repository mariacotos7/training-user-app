defmodule Training.Auth do
    ...
    alias Training.Helpers.MapHelper

    @app_secret_key Application.get_env(:training, :app_secret_key)
    @jwt_validity Application.get_env(:training, :jwt_validity)
